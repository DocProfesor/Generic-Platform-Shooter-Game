...
public class StartingClass extends Applet implements Runnable, KeyListener{
	...
	private Image image, currentSprite, character, character2, character3, characterDown, characterJumped, heliboy, heliboy2, heliboy3, heliboy4, heliboy5, background;
	...
	public void paint(Graphics g) {
		if(state == GameState.Running){
			...
			g.setColor(Color.WHITE);
			g.drawString("You're dead", 360, 240);
		}
	}
	...
	public void keyReleased(KeyEvent e) {
		...
		switch(e.getKeyCode()){
		case KeyEvent.VK_UP:
			System.out.print("Stop moving up");
			break;
